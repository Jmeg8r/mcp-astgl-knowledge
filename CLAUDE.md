...
Per-deliverable checklist (baseline, pipeline script, MCP surface, schema change, new job, PR) relocated to `.claude/skills/astgl-ship-checklist/` — invoke `/astgl-ship-checklist` before shipping any change.
